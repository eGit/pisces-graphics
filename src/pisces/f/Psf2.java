    ...
    public void read(InputStream in) throws IOException {
        ...
        if (IsMagic(magic)){
            ...
            if (1 == (flags & UNITAB)){
                 ...
                 */
                if (idx < length)
                    throw new IllegalArgumentException(String.format("File format error, not all glyphs described (%d/%d).",idx,length));
                else
                    return;
            }
            else {
            ...
            throw new IllegalArgumentException(String.format("Unrecognized file format, magic {0x%x,0x%x,0x%x,0x%x}",(magic[0] & 0xff),(magic[1] & 0xff),(magic[2] & 0xff),(magic[3] & 0xff)));
    }
